...
- Continuously learning **modern web development techniques** and best practices
- Motivated to contribute to real projects and grow as a web developer
...
- **Other Skills:** DOM Manipulation, Event Handling, Form Validation, Basic UI Interactivity, Using JSON with JavaScript
...
- **Key Features:**
  - Contact form validation with DOM
  - CV/Resume section with dynamic download
  - Showcases 2 of my other projects
- **Tech:** HTML5, CSS3, JavaScript
- [Live Demo](https://jigar-portfolio-seven.vercel.app) | [GitHub Repo](https://github.com/JigarBlue/Jigar-Portfolio)
...
- Love learning new techniques, solving problems, and applying them in **practical projects**
